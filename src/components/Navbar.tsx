            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden sm:flex space-x-4">
                        <Link to="/" className="hover:text-[#a2cd5a]">Home</Link>
                        {isAdmin ? <Link to="/admin" className="hover:text-[#a2cd5a]">Admin</Link> : null}
                        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                            <DialogTrigger>
                                <a href="#" className="hover:text-[#a2cd5a]">Logout</a>
                            </DialogTrigger>
                            <DialogContent>
            ...
            {isOpen && (
                <div className="sm:hidden" id="mobile-menu">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        <Link
                            to="/"
                            className="block px-3 py-2 rounded-md text-base font-medium hover:text-[#a2cd5a]"
                            onClick={() => toggleMenu()}
                        >
                            Home
                        </Link>
                        ...
                        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                            <DialogTrigger className="w-full hover:text-[#a2cd5a]">
                                <button
